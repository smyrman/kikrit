...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Adding field 'PurchasedItem.merchandise_name'
		db.add_column('merchandise_purchaseditem', 'merchandise_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

		# Adding field 'PurchasedItem.merchandise_tags'
		db.add_column('merchandise_purchaseditem', 'merchandise_tags', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


	def backwards(self, orm):

		# Deleting field 'PurchasedItem.merchandise_name'
		db.delete_column('merchandise_purchaseditem', 'merchandise_name')

		# Deleting field 'PurchasedItem.merchandise_tags'
		db.delete_column('merchandise_purchaseditem', 'merchandise_tags')
	...
	models = {
		...
		'merchandise.purchaseditem': {
			...
			'merchandise_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
			'merchandise_tags': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
